...
//           <CardDescription>
//             Log in to access your FurnishVerse account.
//           </CardDescription>
//         </CardHeader>
//         <CardContent>
//           {!isOnline && (
...
// This component should not use useSearchParams directly
...
// This wrapper component handles any search params if needed
function LoginFormWrapper() {
  return (
    <Suspense
      fallback={
        <div className="w-full max-w-md p-8">Loading login form...</div>
      }
    >
      <LoginFormContent />
    </Suspense>
